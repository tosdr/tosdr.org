module.exports = {
  ...
  'device-access': [
     { name: 'the (mobile) app of this service requires very broad permissions at install-time', point: 'bad', score: 30 },
  ],
  'data-export': [
  ...
  'ownership': [
    ...
    { name: 'they state that you own your data', point: 'good', score: 10 },
    { name: 'they provide a way to export your data', point: 'good', score: 30 },
  ],
  'personal-data': [
    { name: 'your data is used for many purposes', point: 'bad', score: 40 },
