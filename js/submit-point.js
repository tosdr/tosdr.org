...
$(document).ready(function(){
  ...
  function showPersona(){
    $('#submit-point-form').html('<div class="hero-unit signin"><p>To submit a point, please sign in with your email address.</p><p><img class="signinButton" src="https://developer.mozilla.org/files/3967/plain_sign_in_black.png" alt="Sign in" /></p><p><small>We use Mozilla Persona to verify your email. This service is subject to their <a href="https://login.persona.org/en/tos">Terms</a> and <a href="https://login.persona.org/en/privacy">Privacy Policy</a>.</small></p><!--THIS IS WHAT THE CARD WIDGET SHOULD DISPLAY:--><div class="tosdr-card"><img src="logo/mozilla-persona.png" class="favlogo"><a data-service-name="mozilla-persona" href="/#mozilla-persona">Mozilla Persona</a><div id="mozilla-persona-rating" class="service-rating"><a title="Learn more about our classification" href="classification.html"><span class="label A">Class A</span></a></div></div></div>');
